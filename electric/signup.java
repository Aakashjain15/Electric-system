...
public class signup extends JFrame implements ActionListener {
    ...
    signup(){
        ...
        ImageIcon signupicon = new ImageIcon(ClassLoader.getSystemResource("icon/splash/signupicon.jpeg"));
        Image boyImg = signupicon.getImage().getScaledInstance(250,250,Image.SCALE_DEFAULT);
